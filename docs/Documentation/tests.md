...
<Cards columns={3}>
  <Card title="Accept One-Time Payments" icon="fa-credit-card" target="_blank">
    One-time payments are ideal for a single transaction without storing payment details.
  ...
  <Card title="Accept Payments with Saved Details" icon="fa-save">
    Save customer payment methods securely for faster repeat purchases.
  ...
  <Card title="Accept Recurring Payments" icon="fa-sync-alt">
    Automate charges at defined intervals for subscriptions and memberships.
