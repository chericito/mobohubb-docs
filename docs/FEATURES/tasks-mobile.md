...
title: 'Tasks: Mobile'
excerpt: >-
  Learn how to manage and complete **tasks** in the mobohubb mobile app. This
  guide explains how to access tasks from the landing screen and describes the
  different task types – scan, report, or manual – and how to mark them as done.
deprecated: false
hidden: false
metadata:
  robots: index
...
* How to locate and use the **Tasks** feature from the mobile app’s landing screen or footer menu.
* The difference between **scan tasks**, **report tasks**, and **manual tasks**.
* How to **search for** tasks, **complete** them, and confirm their completion.

***

# Tasks (Mobile)

**Tasks** are activities that employees must perform. They can be anything from repairing a device, delivering an order, building a structure, or providing customer service. Tasks are displayed in lists to streamline viewing and submission of forms or checklists. Depending on the goal, there are several task types:

* **Scan Task**: Requires scanning a **QR code** or **NFC tag**.
* **Report Task**: Opens a **form** for the user to fill out.
* **Manual Task**: Appears as a **checkbox**; not linked to any additional features.
