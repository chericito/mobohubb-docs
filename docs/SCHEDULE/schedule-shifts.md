...
1. **Open** the schedule (see “Manage the Schedule” guide).
...
1. **Click** **“Add new”** in the scheduler.
   * Note: Ensure you’re in the correct schedule (see “Manage the Schedule”).
2. **Choose** **“New shift.”**
3. **Fill** in shift details:
   ...
   * **Skills/Certifications**: (Optional) Link previously created skill/certification.
...
4. **Publish** the shift to make it visible. If you prefer employees can’t see it yet, **save as draft**.
