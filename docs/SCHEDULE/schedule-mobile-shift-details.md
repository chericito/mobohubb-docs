...
* **Start Hour**: The specific start time of the shift.
* **Total Hours**: The length of the shift in hours.
* **Description**: Administrator-provided details about the shift.
* **Note**: Any additional instructions or clarifications.
* **Location**: Where the shift will be performed.
* **Attachments**: Any files linked to the shift (PDFs, images, etc.).
* **Shift Status**: (Approved, Pending Approval, Request a Replacement, Overlapping, etc.).
* **Work Status**: (Started, Not Started, etc.).
...
Tap the **Team** section to see who else is assigned to this shift. You can view:
