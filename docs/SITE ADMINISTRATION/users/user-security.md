...
* **User PIN**: 6‑digit numeric code the user enters on the **mobohubb Kiosk** to clock in/out and manage breaks. The PIN is unique per user and can be regenerated or edited here. (If you also set **“Kiosk timer (user)”**, that countdown overrides the site‑wide timer for this specific PIN.) **[Learn more about Kiosk](https://mobohubb.readme.io/v1.4/docs/mobohubb-kiosk-app#/)**.
