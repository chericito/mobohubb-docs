...
5. **Click** on the **three-dot button** (vertical dots) next to the site parent you wish to manage. This will open a menu with several options:
...
<Tabs>
  <Tab title="Add Site" icon="fa-plus-circle">
    **Add Site**
    ...
    > **Note:** Visit our Site Management section for more details.
  </Tab>
