...
* How to open **My Activity** from the side menu
* How to **scroll** through logs grouped by Task, Forms, Scans, and Timesheet
* How to **filter** activities by date and **view details** like location and submission times

***

# My Activity

**My Activity** is a **log registry** that lists everything you've verified or registered within the app. Entries are grouped by feature (Task, Forms, Scans, Timesheet) so you can quickly see the name of the activity along with the date and time it was submitted.
...
To see more information about a specific activity:

1. **Tap** any log entry in **My Activity.**
2. **View** additional details:
